(function (Drupal, once) {
        ...
        once('teaserImageLinkedBehavior', 'article.teaser-image-linked', context).forEach(teaser => {
          ...
          const teaserHeadlineLink = teaser.querySelector('.teaser--title a');
            if (clickableElement && teaserHeadlineLink) {
              ...
              if (clickableElement && clickableElement.classList.contains('no-image')) {
  ...
  Drupal.behaviors.sectionEssentialsHeightBehavior = {
    attach: function (context, settings) {
      ...
      once('oc-title-bottom-stop', 'div.section--essentials', context).forEach(function (element) {
        ...
        function updateOffsetHeight() {
          ...
          if (parentContainer) {
            parentContainer.style.setProperty('--oc-title-bottom-stop', `${heightInRem}rem`);
          }
        }
