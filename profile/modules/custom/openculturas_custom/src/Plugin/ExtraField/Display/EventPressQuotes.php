...
/**
 * phpcs:ignore
 * field_press_quotes via field_event_description reference.
 *
 * @ExtraFieldDisplay(
 *   id = "event_press_quotes",
 *   label = @Translation("Press quotes"),
 *   description = "field_press_quotes via field_event_description reference",
 *   visible = false,
 *   bundles = {
 *     "node.date",
 *   }
