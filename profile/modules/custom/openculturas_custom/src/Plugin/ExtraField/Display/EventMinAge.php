...
/**
 * Field field_min_age via field_event_description reference.
 */
#[ExtraFieldDisplay(
  id: "event_min_age",
  label: new TranslatableMarkup("Minimum age"),
  description: new TranslatableMarkup("field_min_age via field_event_description reference"),
  bundles: [
    "node.date",
  ],
  visible: FALSE,
