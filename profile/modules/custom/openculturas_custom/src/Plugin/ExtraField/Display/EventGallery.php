...
/**
 * Field field_gallery via field_event_description reference.
 */
#[ExtraFieldDisplay(
  id: "event_gallery",
  label: new TranslatableMarkup("Gallery"),
  description: new TranslatableMarkup("field_gallery via field_event_description reference"),
  bundles: [
    "node.date",
  ],
  visible: FALSE,
